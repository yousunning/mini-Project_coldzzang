CREATE TABLE `회원` (
	`u_id`	NUMBER	NOT NULL	COMMENT '회원의 정보를 식별하기 위한 기본키',
	...
	`f_id`	NUMBER	NOT NULL	COMMENT '재료를 식별하기 위한 기본키'
);
...
CREATE TABLE `레시피` (
	`r_id`	NUMBER	NOT NULL	COMMENT '레시피 정보를 식별하기 위한 기본키',
	`recipe_name`	VARCHAR2(100)	NULL	COMMENT '영문자, 숫자 , 특수문자 전부 가능',
