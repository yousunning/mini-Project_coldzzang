...
<body>
    ...
    <a href="/food/List/like" class="btn btn-secondary btn-lg active" role="button" aria-pressed="true">즐겨찾기</a>
    <a href="/food/List/recipe" class="btn btn-secondary btn-lg active" role="button" aria-pressed="true">레시피 찾기</a>
    <a href="/food/List/myStatistics" class="btn btn-secondary btn-lg active" role="button" aria-pressed="true">통계</a>
